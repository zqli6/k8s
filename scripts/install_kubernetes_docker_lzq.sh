...
IMAGES_URL="swr.cn-southwest-2.myhuaweicloud.com/zqli/google_containers"
...
EOF
    ...
    #sed -i '/^ExecStart/s#$# --pod-infra-container-image swr.cn-southwest-2.myhuaweicloud.com/zqli/google_containers/pause:'$PAUSE_VERSION#   /lib/systemd/system/cri-docker.service
